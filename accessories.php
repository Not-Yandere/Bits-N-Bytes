...
// Fetch total number of items in the accessories category
$totalItemsQuery = "SELECT COUNT(*) AS total FROM items WHERE Category like '%Accessories%'";
...
$sql = "SELECT * FROM items WHERE Category like '%Accessories%' LIMIT $offset, $itemsPerPage";
...
<head>
    ...
    <title>Accessories - Bits N Bytes</title>
...
<?php include 'header.php';?>
    ...
    <div class="content">
        <br>
        <h2 class="sub-title">Accessories</h2>
