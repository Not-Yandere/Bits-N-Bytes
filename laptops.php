...
// Fetch total number of items in the Laptops category
$totalItemsQuery = "SELECT COUNT(*) AS total FROM items WHERE Category like '%Laptops%'";
...
$sql = "SELECT * FROM items WHERE Category like '%Laptops%' LIMIT $offset, $itemsPerPage";
...
<head>
    ...
    <title>Laptops - Bits N Bytes</title>
