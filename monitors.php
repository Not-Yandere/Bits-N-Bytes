...
// Fetch total number of items in the Monitors category
$totalItemsQuery = "SELECT COUNT(*) AS total FROM items WHERE Category like '%Monitors%'";
...
$sql = "SELECT * FROM items WHERE Category like '%Monitors%' LIMIT $offset, $itemsPerPage";
...
<head>
    ...
    <title>Monitors - Bits N Bytes</title>
...
<?php include 'header.php';?>
    ...
    <div class="content">
        <br>
        <h2 class="sub-title">Monitors</h2>
