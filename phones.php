...
// Fetch total number of items in the Phones category
$totalItemsQuery = "SELECT COUNT(*) AS total FROM items WHERE Category like '%Phones%'";
...
$sql = "SELECT * FROM items WHERE Category like '%Phones%' LIMIT $offset, $itemsPerPage";
...
<head>
    ...
    <title>Phones - Bits N Bytes</title>
