...
// Fetch total number of items in the Hardware category
$totalItemsQuery = "SELECT COUNT(*) AS total FROM items WHERE Category like '%Hardware%'";
...
$sql = "SELECT * FROM items WHERE Category like '%Hardware%' LIMIT $offset, $itemsPerPage";
...
<head>
    ...
    <title>Hardware - Bits N Bytes</title>
...
<?php include 'header.php';?>
    ...
    <div class="content">
        <br>
        <h2 class="sub-title">Hardware</h2>
