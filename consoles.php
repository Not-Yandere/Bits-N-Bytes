...
// Fetch total number of items in the consoles category
$totalItemsQuery = "SELECT COUNT(*) AS total FROM items WHERE Category like '%consoles%'";
...
$sql = "SELECT * FROM items WHERE Category like '%consoles%' LIMIT $offset, $itemsPerPage";
...
<head>
    ...
    <title>consoles - Bits N Bytes</title>
...
<?php include 'header.php';?>
    ...
    <div class="content">
        <br>
        <h2 class="sub-title">consoles</h2>
